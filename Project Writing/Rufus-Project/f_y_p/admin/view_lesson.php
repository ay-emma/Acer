...
<head>
<title>VirtualClass! - <?php echo $row_rs_lesson['title_lssn']; ?> : Admin</title>
...
<div id="content">
  <div id="colOne">
      ...
      <h5 class="posted">Posted on <a href="#"><?php echo $row_rs_lesson['date_added_lssn']; ?></a></h5>
  ...
  <table width="80%" border="0" align="center">
    ...
    <tr>
      ...
      <input type="hidden" name="id_pst" value="<?php echo $row_rs_lesson['id_lssn']; ?>" />
      <input type="hidden" name="id_usr" value="<?php echo $_SESSION['usr_lct']; ?>" />
